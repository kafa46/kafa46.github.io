...
# - 그러나 표준 라이브러리(`stdlib`) 이외의 코딩에서 [PEP 484 - Type Hints](https://www.python.org/dev/peps/pep-0484/) 코딩 스타일을 사용하는 것은 추천합니다. 이때 [PEP 484 - Type Hints](https://www.python.org/dev/peps/pep-0484/)를 사용하는 것이 함수 설명을 추가하는 것에 필요한 노력이나 가독성 증대를 검토한 후 사용할 것을 추천합니다.
